...
def create_app() -> FastAPI:
    ...
    application = FastAPI(
        ...
        description=(
            ...
            "WARNING: This service is not a medical device and must not be used for real clinical decisions."
        ),
    )
    ...
    application.include_router(vision_router, prefix=settings.api_prefix)
    return application
